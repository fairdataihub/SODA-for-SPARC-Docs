    ...
    <Layout title="Versions" description="Versions page listing all documented site versions">
      <Head>
        <meta
          ...
          content="https://kalai.fairdataihub.org/api/generate?app=soda-for-sparc&title=Documentation%20versions&description=Match%20every%20docs%20version%20to%20an%20app%20version&org=fairdataihub"
        />
        <meta
      ...
      <main className="margin-vert--lg container">
        ...
        <p>
          ...
          appropriate version of SODA for SPARC. Since our documentation is versioned and released
          automatically using{' '}
          ...
          <table>
            <thead>
              <tr>
                ...
                <th>SODA for SPARC app version</th>
              </tr>
            </thead>
        ...
        <div className="margin-bottom--lg">
          ...
          <p>
            <span id="versionsPage.archived.description">
              Here you can find documentation for previous versions of SODA for SPARC. Some of these
              ...
              <Link to="https://doi.org/10.5281/zenodo.6407300">Zenodo archive</Link>.
            </span>
          </p>
