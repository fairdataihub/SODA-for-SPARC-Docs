...
image: https://kalai.fairdataihub.org/api/generate?app=soda-for-sparc&title=Structure%20the%20subjects%20metadata%20file&description=%27How%20to%27%20SPARC%20series&org=fairdataihub
---

## Background

SODA helps you prepare the [subjects metadata file](../Freeform%20Mode/prepare-metadata/create-subjects.md) conveniently. While SODA automatically generates the file in the required structure, we explain here how it must be structured according to the SPARC rules in order to provide some insight about the structure of the file generated by SODA.
