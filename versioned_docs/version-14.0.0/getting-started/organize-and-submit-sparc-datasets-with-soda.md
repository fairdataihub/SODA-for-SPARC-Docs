...
If you are only uploading data to an existing dataset, you can use the `Upload Dataset` mode. Follow the associated documentation [here](../upload-dataset/organize-dataset).
