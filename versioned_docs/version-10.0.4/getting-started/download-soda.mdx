...
3. Try opening SODA. You may get the error message: "SODA for SPARC" cannot be opened because the developer cannot be verified." If so, click on the apple logo in the top corner and go to
