...
SODA helps you prepare the [submission metadata file](../prepare-metadata/create-submission) conveniently. We explain here how it must be structured according to the SPARC rules in order to provide some insight about the structure of the file generated by SODA.
