...
Start by selecting/confirming your Pennsieve account and dataset. If you have not connected your Pennsieve account with SODA yet, see [here](Connect-your-Pennsieve-account-with-SODA). The current permissions on the selected dataset will be displayed.
