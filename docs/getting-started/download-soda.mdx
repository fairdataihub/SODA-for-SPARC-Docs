...
image: https://og.fairdataihub.org/api/ogimage?app=soda-for-sparc&title=Submit%20for%20pre%20publishing%20review&description=Getting%20Started
---

To use SODA, first download and install the [Pennsieve Agent](https://docs.pennsieve.io/v1/docs/the-pennsieve-agent).
...
3. Try opening SODA. You may get the error message: "SODA for SPARC" cannot be opened because the developer cannot be verified." If so, click on the Apple logo in the top left corner and go to
